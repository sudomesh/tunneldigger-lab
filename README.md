...
It is also possible to set up your own broker within the client machine or on a hosted server (such as on digitalocean). You can follow instructions published at http://tunneldigger.readthedocs.io/en/latest/server.html . Perhaps easiest way to setup a broker is to follow instructions and/or inspect scripts published at https://github.com/sudomesh/exitnode .
